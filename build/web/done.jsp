...
<!DOCTYPE html>
<html lang="en">
    <!--JSP page to show completed todo list-->
    <head>
        <meta charset="utf-8" />
        <link rel="apple-touch-icon" sizes="76x76" href="assets/img/apple-icon.png">
        <link rel="icon" type="image/png" href="assets/img/favicon.png">
        <title>
            Digi-Notes List History
        </title>
    ...
    <body class="dark-edition">
        <sql:setDataSource url="jdbc:mysql://localhost:3306/todolist"
                           ...
                           user="root"
                           password="" />
        <sql:query sql="SELECT * FROM todo WHERE uid=${sessionScope.uid} and status=1" var="r">
        ...
        <div class="wrapper ">
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    ...
                    <% }%>
                    <h4 class="text-muted">Completed Tasks list</h4><br>
